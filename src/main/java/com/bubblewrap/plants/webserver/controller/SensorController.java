...
public class SensorController {
	...
	@RequestMapping(value = "/light/recentData" , produces = {MediaType.APPLICATION_JSON_VALUE})
	...
	@RequestMapping(value = "/temp/recentData" , produces = {MediaType.APPLICATION_JSON_VALUE})
